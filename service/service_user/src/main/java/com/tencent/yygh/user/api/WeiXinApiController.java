...
import com.tencent.yygh.user.utils.ConstantWxPropertiesUtils;
import com.tencent.yygh.user.utils.HttpClientUtils;
...
public class WeiXinApiController {
    ...
    public String callback(String code, String state) {
        ...
        try {
            ...
            //判断数据库是否存在微信的扫描人信息
            //根据openid判断
            UserInfo userInfo = userInfoApiService.selectWxInfoOpenId(openid);
